...
const DocumentUpload = () => {
  ...
  const processDocument = async (file: File): Promise<{ summary: string; keyPoints: string[] }> => {
    ...
    return {
      summary: `This legal document appears to be a ${file.name.includes('contract') ? 'contract' : 'legal agreement'} that outlines terms and conditions between parties. The document contains standard legal provisions including definitions, obligations, rights, and remedies. Key clauses address performance requirements, payment terms, dispute resolution, and termination conditions. The language used is formal legal terminology that may require professional interpretation for complete understanding.`,
      keyPoints: [
        "Contains binding legal obligations for all parties involved",
        "Specifies dispute resolution mechanisms and jurisdiction",
        "Includes standard indemnification and liability clauses",
        "Outlines termination conditions and notice requirements",
        "References applicable laws and regulatory compliance",
